package = "kong-plugin-zenskar"  -- TODO: rename, must match the info in the filename of this rockspec!
...
build = {
  ...
  modules = {
    ...
    ["kong.plugins."..pluginName..".logger"] = "kong/plugins/"..pluginName.."/logger.lua",
    ["kong.plugins."..pluginName..".base64"] = "kong/plugins/"..pluginName.."/base64.lua",
    ...
    ["kong.plugins."..pluginName..".ip_resolver"] = "kong/plugins/"..pluginName.."/ip_resolver.lua",
  }
}
